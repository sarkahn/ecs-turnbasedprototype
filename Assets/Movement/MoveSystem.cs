...
namespace TurnBasedTutorial.Movement
{
    ...
    {
        public int2 value;
        public static implicit operator int2(TryMove c) => c.value;
        public static implicit operator TryMove(int2 v) => new TryMove { value = v };
    }
    ...
    public class MoveSystem : JobComponentSystem
    {
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            inputDeps = Entities
                ...
                {
                    int2 targetPos = (int2)math.round(t.Value.xz + move.value);
